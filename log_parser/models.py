...
class Configuration(models.Model):
    name = models.CharField(max_length=100, verbose_name="Name", default="textfile")
    access_log_path = models.CharField(
        verbose_name="Access Log Path", max_length=255, null=True, blank=True
    )
    file_path = models.FileField(verbose_name="File Path", upload_to='media', default=None, null=True, blank=True)
...
class ApacheLogs(models.Model):
    ...
    referer = models.CharField(verbose_name="Referer", max_length=100, blank=True, null=True)
    user_agent = models.CharField(verbose_name="User Agent", max_length=255, null=True, blank=True)
    remote_host = models.CharField(
        verbose_name="Remote Host", max_length=100, blank=True, null=True
    )
    remote_logname = models.CharField(
        verbose_name="Remote Log Name", max_length=100, blank=True, null=True
    )
    remote_user = models.CharField(
        verbose_name="Remote User", max_length=100, blank=True, null=True
    )
    request_line = models.CharField(
        verbose_name="Request Line", max_length=100, blank=True, null=True
    )
    final_status = models.CharField(
        verbose_name="Final Status", max_length=100, blank=True, null=True
    )
...
class CeleryLogs(models.Model):
    name = models.CharField(verbose_name="Task Name", max_length=100, blank=True, null=True)
